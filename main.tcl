...
#
# main.tcl: Tcl script for re-creating project 'MixerVProject'
#
# Generated by Vivado on Mon Jan 16 15:27:46 +03 2023
...
#
#    "/home/ambat/Work/Mixer/MixerVProject/MixerVProject.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"
#
...
set _xil_proj_name_ "MixerVProject"
...
set orig_proj_dir "[file normalize "$origin_dir/MixerVProject"]"
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/Mixer_HLS"]" $obj
...
set files [list \
 [file normalize "${origin_dir}/MixerVProject/MixerVProject.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]\
]
...
proc cr_bd_design_1 { parentCell } {
  ...
  set Mixer_0 [ create_bd_cell -type ip -vlnv Mosanada:V:Mixer:0.1 Mixer_0 ]
  ...
  connect_bd_intf_net -intf_net Mixer_0_OUTPUT_r [get_bd_intf_pins Mixer_0/OUTPUT_r] [get_bd_intf_pins axi_vdma_0/S_AXIS_S2MM]
connect_bd_intf_net -intf_net [get_bd_intf_nets Mixer_0_OUTPUT_r] [get_bd_intf_pins Mixer_0/OUTPUT_r] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
  connect_bd_intf_net -intf_net axi_vdma_0_M_AXIS_MM2S [get_bd_intf_pins Mixer_0/OVERLAY] [get_bd_intf_pins axi_vdma_0/M_AXIS_MM2S]
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_vdma_0_M_AXIS_MM2S] [get_bd_intf_pins axi_vdma_0/M_AXIS_MM2S] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins Mixer_0/s_axi_cmd] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  ...
  connect_bd_intf_net -intf_net v_tpg_0_m_axis_video [get_bd_intf_pins Mixer_0/MAIN] [get_bd_intf_pins v_tpg_0/m_axis_video]
connect_bd_intf_net -intf_net [get_bd_intf_nets v_tpg_0_m_axis_video] [get_bd_intf_pins Mixer_0/MAIN] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]

  # Create port connections
  connect_bd_net -net axi_vdma_0_mm2s_introut [get_bd_pins axi_vdma_0/mm2s_introut] [get_bd_pins system_ila_0/probe1]
  connect_bd_net -net axi_vdma_0_s2mm_introut [get_bd_pins axi_vdma_0/s2mm_introut] [get_bd_pins system_ila_0/probe2]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Mixer_0/ap_clk] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins system_ila_0/clk] [get_bd_pins v_tpg_0/ap_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins Mixer_0/ap_rst_n] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins system_ila_0/resetn] [get_bd_pins v_tpg_0/ap_rst_n]
  connect_bd_net -net v_tpg_0_interrupt [get_bd_pins system_ila_0/probe0] [get_bd_pins v_tpg_0/interrupt]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Mixer_0/s_axi_cmd/Reg] SEG_Mixer_0_Reg
